# TODO - doctor-note-summarizer

Repository: https://github.com/RanaPriyansh/doctor-note-summarizer.git
Canonical local path: /root/git-repos/app-factory/apps/doctor-note-summarizer
...
3. Run the local setup path for doctor-note-summarizer and write exact commands back into README if they are missing or stale.
