# Deploying AI Doctor Note Summarizer

## Backend (One-time)
1. Create Stripe product and price ($9/month)
...
## iOS App
1. Open Xcode project in iOS/DoctorNoteSummarizer/
2. Set bundle identifier: com.appfactory.doctornotesummarizer
...
- Create product: "AI Doctor Note Summarizer" ($9/mo)
